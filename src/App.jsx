...
import { EMBLEM_DATA_URI, BADGE_DATA_URI } from "./emblem.js";
        ...
        <>
              <header className="nav">
                      ...
                      <nav className={`nav-links ${menuOpen ? "nav-links-open" : ""}`}>
                                <a href="#cronica" onClick={() => setMenuOpen(false)}>Crónica</a>a>
                                <a href="#torneo" onClick={() => setMenuOpen(false)}>Próximo torneo</a>a>
                                <a href="#contacto" onClick={() => setMenuOpen(false)}>Contacto</a>a>
                      </nav>nav>
              </header>header>
              ...
              <main>
                      ...
                      <section id="torneo" className="tournament">
                                <div className="tournament-card">
                                            <img src={BADGE_DATA_URI} alt="Insignia II Open Villa Errenteria" className="tournament-badge" />
          ...
          {lightbox && (
                  <div className="lightbox" onClick={() => setLightbox(null)}>
                            <button className="lightbox-close" onClick={() => setLightbox(null)} aria-label="Cerrar">✕</button>button>
                            <img src={lightbox} alt="" onClick={(e) => e.stopPropagation()} />
                  </div>div>
              )}
        
              <footer id="contacto" className="footer">
                      <p>© {new Date().getFullYear()} · Vikings Darts Club</p>p>
              </footer>footer>
        </>>
      );
}
